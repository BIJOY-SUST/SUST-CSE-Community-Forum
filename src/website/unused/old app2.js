                                        ...
                                        await Posts.find({ userORGroupUniqueID: allMan, isUserOrGroup: 'user' }).then(async function (friendAllPostList) {
                                            ...
                                            await Likes.find({ originPostUniqueID: allMyPost_Like, ownerLikeUniqueID: req.cookies.key }).then(async function (resultAllLikeList) {
                                                ...
                                                res.render('home', {
                                                    ...
                                                    resultAllUnreadNotification: resultAllUnreadNotification.length
...
app.post('/groupCommentUploadEachPostFromHome', urlencodedParser, async function (req, res) {
    ...
    var eachPostUniqueID = req.body.postKeyValue;
    var groupKeyValue = req.body.groupKeyValue;
    var eachPostOwnerUniqueID = req.body.postOwnerUniqueValue;
                                        ...
                                        await groupMembers.findOne({ groupUniqueId: groupKeyValue, userUniqueId: req.cookies.key }).then(async function (youKnowWho) {
                                            ...
                                            await Posts.findOne({ postUniqueId: eachPostUniqueID }).then(async function (resultOnePost) {
                                                ...
                                                await Comments.find({ originPostUniqueID: eachPostUniqueID }).then((resultPerPost) => {
                                                    ...
                                                    res.render('viewGroupOnePostFromHome', {
                                                        myKey: req.cookies.key,
                                                        myName: req.cookies.name,
                                                        myProPic: req.cookies.proPicAddr,
                                                        myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/groupCommentSetting', urlencodedParser, async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
        ...
        else if (settingBtn === "editCommentBtn") {
            console.log('edit e dhukse');
            await Comments.findOne({ commentUniqueId: eachCommentUniqueID }).then(async function (resultOneComment) {
                console.log('post ta paise')
                // console.log(resultOnePost);
                await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                    var allGroup = []
                    ...
                    await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                        ...
                        res.render('editGroupComment', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,

                            eachPostUniqueID: eachPostUniqueID,
                            singleGroupKey: groupKeyValue,

                            resultOneComment: resultOneComment,
            ...
            await Comments.findOne({ commentUniqueId: eachCommentUniqueID }).then(async function (resultOneComment) {
                ...
                await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                    ...
                    await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                        ...
                        res.render('editGroupCommentFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/groupEachPostCommentSettingFromHome', urlencodedParser, async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
    else {
        console.log('button click mission successfull');
        var settingBtn = req.body.commentBtn;
            ...
            await Comments.findOne({ commentUniqueId: eachCommentUniqueID }).then(async function (resultOneComment) {
                ...
                await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                    ...
                    await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                        ...
                        res.render('editGroupCommentEachPostFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
                            ...
                            eachPostOwnerUniqueID: eachPostOwnerUniqueID,
...
app.post('/editGroupCommentEachPostFromHome', urlencodedParser, async function (req, res) {
...
app.post('/groupCoverPicChange', dirCoverPic.single('myImage'), urlencodedParser, async function (req, res) {
    ...
    await fileNewPath(preFilePath, newFilePath).then(async function (result) {
        ...
        await Groups.updateOne({
            ...
            await Groups.findOne({ groupUniqueId: groupKeyValue }).then(async function (okGroup){
                await groupMembers.find({groupUniqueId: groupKeyValue, isAdmin:"yes"}).then(async function (allAdmin){
                    await groupMembers.find({ groupUniqueId: groupKeyValue, isAdmin: '' }).then(async function (allMember) {
                        
                        var youKnowWho = {
                            groupUniqueId: okGroup.groupUniqueId,
                            userUniqueId: req.cookies.key,
                            userName: req.cookies.name,
                            userPicAddr: req.cookies.proPicAddr,
                            isAdmin: 'yes'
...
app.get('/groupProfile', function (req, res) {
    res.render('groupProfile')
})

app.post('/userRemoveOrMakeAdmin',urlencodedParser, function (req, res) {
    res.redirect('home');
})
...
app.get('/messenger', async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
        ...
        await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
            ...
            // console.log(allMan);
            await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                resultAllFreeGroup = resultAllFreeGroup.slice(0, 7);
        ...
        await Notifications.updateOne({
            ...
            await Notifications.findOne({ notifyUniqueId: notifySettingID }).then(async function (singleNotify) {
                if(singleNotify.isGroup === "yes"){
                    ...
                    console.log('like or comment related notification');
...
app.post('/groupPostSettingFromHome', urlencodedParser, async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
    else {
        // console.log('button click mission successfull')
        var settingBtn = req.body.settingBtn;
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Posts.findOne({ postUniqueId: everyPostUniqueID }).then(async function (resultOnePost) {
                        ...
                        res.render('editGroupOnePostFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/groupPostSettingEachPostFromHome', urlencodedParser, async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
    else {
        // console.log('button click mission successfull')
        var settingBtn = req.body.settingBtn;
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Posts.findOne({ postUniqueId: everyPostUniqueID }).then(async function (resultOnePost) {
                        ...
                        res.render('editGroupOnePostEachPostFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/editGroupPostEachPostFromHome', dirPostFile.single('myFile'), urlencodedParser, async function (req, res) {
...
app.post('/userCommentUploadEachPostFromHome', urlencodedParser, async function (req, res) {
    ...
    var date = today.getDate() + ' ' + monthNames[today.getMonth()] + ' ' + today.getFullYear();
    var dateTime = time + ', ' + date;
    var postOwnerNumber = req.body.myFriendUserUniqueValue;
                    ...
                    await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                        ...
                        await Posts.findOne({ postUniqueId: req.body.postKeyValue }).then(async function (resultOnePost) {
                            ...
                            await Comments.find({ originPostUniqueID: req.body.postKeyValue }).then((resultPerPost) => {
                                ...
                                res.render('viewMyOnePostFromHome', {
                                    myKey: req.cookies.key,
                                    myName: req.cookies.name,
                                    myProPic: req.cookies.proPicAddr,
                                    myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/myPostSettingFromHome', urlencodedParser, async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
    else {
        // console.log('button click mission successfull')
        var settingBtn = req.body.settingBtn;
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Posts.findOne({ postUniqueId: everyPostUniqueID }).then(async function (resultOnePost) {
                        ...
                        res.render('editMyOnePostFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/myPostSettingEachPostFromHome', urlencodedParser, async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
    else {
        // console.log('button click mission successfull')
        var settingBtn = req.body.settingBtn;
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Posts.findOne({ postUniqueId: everyPostUniqueID }).then(async function (resultOnePost) {
                        ...
                        res.render('editMyOnePostEachPostFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/editPostEachPostFromHome', dirPostFile.single('myFile'), urlencodedParser, async function (req, res) {
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Comments.findOne({ commentUniqueId: eachCommentUniqueID }).then(async function (resultOneComment) {
                        ...
                        res.render('editMyOneCommentFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Comments.findOne({ commentUniqueId: eachCommentUniqueID }).then(async function (resultOneComment) {
                        ...
                        res.render('editMyOneCommentFromEachPost', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/myEachPostCommentSettingFromHome', urlencodedParser, async function (req, res) {
    if (req.cookies.key === undefined) res.render('index');
    else {
        // console.log('button click mission successfull')
        var settingBtn = req.body.commentBtn;
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Comments.findOne({ commentUniqueId: eachCommentUniqueID }).then(async function (resultOneComment) {
                        ...
                        res.render('editMyOneCommentFromEachPostFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,
...
app.post('/editCommentFromEachPostFromHome', urlencodedParser, async function (req, res) {
...
// app.post('/changeLikeCount', urlencodedParser, async function (req, res) {

//     var groupIdLikeCnt = req.body.groupIdLikeCnt;
//     // console.log(groupIdLikeCnt);
//     await Posts.updateOne({
//         postUniqueId: groupIdLikeCnt
//     }, {
//         $inc: {
//             likeCount: 1
//         }
...
//         console.log('Like count changed successfully');
            ...
            await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                ...
                await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                    ...
                    await Comments.findOne({ commentUniqueId: eachCommentUniqueID }).then(async function (resultOneComment) {
                        ...
                        res.render('editMyFriendProfileCommentFromHome', {
                            myKey: req.cookies.key,
                            myName: req.cookies.name,
                            myProPic: req.cookies.proPicAddr,
                            myCoverPic: req.cookies.proCoverPicAddr,

                            postOwnerUniqueID: req.body.postOwnerID,
                            resultOneComment: resultOneComment,
            ...
            if (commentOwnerID === req.cookies.key) {
                ...
                await groupMembers.find({ userUniqueId: req.cookies.key }).then(async function (resultAllGroup) {
                    ...
                    await Groups.find({ groupUniqueId: allGroup }).then(async function (resultAllFreeGroup) {
                        ...
                        await Follows.find({ followerID: commentOwnerID }).then(async function (resultFollower) {

                            await Follows.find({ followingID: commentOwnerID }).then(async function (resultFollowing) {

                                await Users.findOne({ userUniqueId: commentOwnerID }).then(async function (resultUser) {

                                    await Posts.find({ userORGroupUniqueID: commentOwnerID, isUserOrGroup: 'user' }).then(async function (allUserList) {
                                        console.log('Collect all post from database')
                                        var allMyPost = allUserList;
